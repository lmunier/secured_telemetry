This work is taken from the c_uart_interface_example and a little bit modified. It still in progress, actually two scripts, mavlink_control_send and mavlnk_control_receive, have to be run just to test the feasibility of this method before going forward and implement it better.
